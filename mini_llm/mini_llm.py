...
def train_model(model, dataset, epochs=100, batch_size=32, learning_rate=0.003):
...
if __name__ == "__main__":
    ...
    # Go up one level to find training_data.txt
    data_path = os.path.join(script_dir, '..', 'training_data.txt')
    ...
    print(f"Characters (printable): {repr(chars_str)}")
    ...
    # Train model
    print("\nStarting training...")
    train_model(model, dataset, epochs=100, batch_size=16, learning_rate=0.005)
